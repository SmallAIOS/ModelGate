# repo-security Specification

## Purpose

Security baseline for the ModelGate repository: dependency-advisory gates (RustSec via CI for the Rust workspace, Dependabot for npm), GitHub secret-scanning posture, and ignore hygiene that keeps local logs and worktrees out of the public repo. Established by `security-hygiene-v1`.
